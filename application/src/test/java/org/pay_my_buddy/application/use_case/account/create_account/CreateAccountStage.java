package org.pay_my_buddy.application.use_case.account.create_account;
...
import org.pay_my_buddy.application.use_case.account.command.create_account.CreateAccountCommand;
import org.pay_my_buddy.application.use_case.account.command.create_account.CreateAccountUseCase;
...
public class CreateAccountStage extends Stage<CreateAccountStage> {
    ...
    public CreateAccountStage a_command_to_create_account() {
        this.command = CreateAccountCommand.of(userId);
        return self();
    }
    ...
    public CreateAccountStage the_account_is_saved() {
        ...
        Assertions.assertEquals(BigDecimal.ZERO, this.account.balance().value());
