...
import org.pay_my_buddy.api_command.event_storage.EventWrapper;
...
public abstract class AbstractAggregateRoot<ID extends EntityId> implements Serializable {
	...
	private <EVENT extends Event> void applyChanges(EVENT event) {
		Arrays.stream(this.getClass().getDeclaredMethods())
				...
				.reduce((a, b) -> {
					throw new InternalErrorException("Multiple event handlers found for event type: " + event.getClass());
				})
